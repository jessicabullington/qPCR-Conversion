---
title: "Plate9_GenBac_qPCRConversion"
...
data <- read.csv("Plate9_GenBac_qPCRConversion.csv")
View(data)
...
```{r}
# write csv file
write.csv(unknowns, file = "Plate9_GenBac_ConvertedData.csv", row.names=FALSE, na="")
...
write.csv(data.average, file = "Plate9_GenBac_Averaged.csv", row.names=FALSE, na="")
```
