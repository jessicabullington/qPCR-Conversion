---
title: "Plate9_Entero_qPCRConversion.csv"
...
data <- read.csv("Plate9_Entero_qPCRConversion.csv")
View(data)
...
```{r}
# write csv file
write.csv(unknowns, file = "Plate9_Entero_ConvertedData.csv", row.names=FALSE, na="")
...
write.csv(data.average, file = "Plate9_Entero_Averaged.csv", row.names=FALSE, na="")
```
