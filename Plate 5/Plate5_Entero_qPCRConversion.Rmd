---
title: "Plate5_Entero_qPCRConversion"
...
data <- read.csv("Plate5_Entero_qPCRConversion.csv")
View(data)
...
```{r}
# write csv file
write.csv(unknowns, file = "Plate5_Entero_ConvertedData.csv", row.names=FALSE, na="")
...
write.csv(data.average, file = "Plate5_Entero_Averaged.csv", row.names=FALSE, na="")
```
