---
title: "Plate1_GenBac_qPCRConversion"
...
unknowns = unknowns[1:72,]
qplot(SampleIDNum,log10(copies.ml), data=unknowns, col=DilutionFactor)
```
...
write.csv(data.average, file = "Plate1_GenBac_Averaged.csv", row.names=FALSE, na="")
```
