...
# check class of Ct and copy number, change to numeric if needed
#class(data$CT) # check the data class type
#data$CT <- as.numeric(as.character(data$CT)) # change to numeric, NA warning ok
```
...
unknowns$plate_num = 1 # note:change to the actual plate number
...
qplot(SampleIDNum,log(copies.ml+1), data=unknowns, col=DilutionFactor)
```
