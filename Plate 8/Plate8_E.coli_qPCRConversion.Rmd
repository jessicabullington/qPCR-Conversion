---
title: "Plate8_E.coli_qPCRConversion"
...
data <- read.csv("Plate8_E.coli_qPCRConversion.csv")
View(data)
...
```{r}
# write csv file
write.csv(unknowns, file = "Plate8_E.coli_ConvertedData.csv", row.names=FALSE, na="")
...
write.csv(data.average, file = "Plate8_E.coli_Averaged.csv", row.names=FALSE, na="")
```
