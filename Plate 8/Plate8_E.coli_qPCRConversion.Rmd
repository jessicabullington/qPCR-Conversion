...
### Remove standards that sucked (in this case, just use a global std curve since curve is offset)
```{r}
standard_slope = -3.39646
standard_intercept = 37.09888
```
