---
title: "Plate4_Entero_qPCRConversion"
...
```{r}
# write csv file
write.csv(unknowns, file = "Plate4_Entero_ConvertedData.csv", row.names=FALSE, na="")
...
write.csv(data.average, file = "Plate4_Entero_Averaged.csv", row.names=FALSE, na="")
```
