---
title: "Plate4_GenBac_qPCRConversion"
...
data <- read.csv("Plate4_GenBac_qPCRConversion.csv")
View(data)
...
```{r}
# write csv file
write.csv(unknowns, file = "Plate4_GenBac_ConvertedData.csv", row.names=FALSE, na="")
...
write.csv(averaged, file = "Plate4_GenBac_Averaged.csv", row.names=FALSE, na="")
```
