---
title: "Plate4_E.coli_qPCRConversion"
...
data <- read.csv("Plate4_E.coli_qPCRConversion.csv")
View(data)
...
```{r}
# write csv file
write.csv(unknowns, file = "Plate4_E.coli_ConvertedData.csv", row.names=FALSE, na="")
...
write.csv(averaged, file = "Plate4_E.coli_Averaged.csv", row.names=FALSE, na="")
```
